...
if ARGS.count == "all":
    ...
    JSON_USER = json.loads(USER_STATS.decode())
...
while TOTAL_DOWNLOADED < TOTAL_TO_DOWNLOAD:
    ...
    LIST = json.loads(ACTIVITY_LIST.decode())
    # print(LIST)
...
activity...",
        ...
        JSON_SUMMARY = json.loads(ACTIVITY_SUMMARY.decode())
        # print(JSON_SUMMARY)
        ...
        if DEVICE_DETAIL:
            ...
            JSON_DEVICE = json.loads(DEVICE_DETAIL.decode())
            # print(JSON_DEVICE)
        else:
        ...
        try:
            ...
            JSON_DETAIL = json.loads(ACTIVITY_DETAIL.decode())
            # print(JSON_DETAIL)
        except:
        ...
        try:
            ...
            JSON_GEAR = json.loads(GEAR_DETAIL.decode())
            # print(JSON_GEAR)
        except:
